<div id="cast-list">
   @foreach( $movie->cast as $actor )
      <div class="row">
         ...
         <div class="col-xs-2">
            <a class="btn btn-block btn-default btn-xs" onclick="editCastMember('{{$actor->person_id}}', '{{$actor->pivot->character}}')" href="javascript:void(0)"><i class="ft icon-edit"></i> <span class="hidden-xs hidden-sm">edit</span></a>
         </div>
         <div class="col-xs-2">
