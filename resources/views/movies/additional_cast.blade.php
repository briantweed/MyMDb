   ...
   @foreach( $additional as $actor )
      <div class="row">
         ...
         <div class="col-xs-2" style="padding-top:18px">
            <a class="btn btn-block btn-success-outline btn-xs" onclick="showModal('createImdbActor','{{$actor->actorId}}'); setCharacterName('{{$actor->character}}')" href="javascript:void(0)"><i class="ft icon-plus"></i> <span class="hidden-xs hidden-sm">add</span></a>
         </div>
         <div class="col-xs-2" style="padding-top:18px">
