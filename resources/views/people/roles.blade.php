<div id="role-list">
   @foreach( $person->roles as $role )
      <div class="row cast">
         ...
         <div class="col-xs-2">
            <a class="btn btn-block btn-default btn-xs" onclick="editMovieRole({{$role->movie_id}},'{{$role->pivot->character}}')" href="javascript:void(0)"><i class="ft icon-edit"></i> edit</a>
         </div>
         <div class="col-xs-2">
