	...
	public function run()
	{
		...
		if( !$existing )
		{
			...
			$fields = [
				...
				['create_movie','35','movie_purchased','Purchased','0','date','','','','',''],
				['create_movie','40','movie_my_rating','Rating','1','range','1','10','','',''],
				['create_movie','50','movie_release_date','Released','1','range','1930','9999','','',''],
				['create_movie','60','movie_running_time','Running Time','1','text','','','','',''],
				['create_movie','70','movie_certificate_id','Certificate','1','select','','','certificates','',''],
				['create_movie','80','movie_format_id','Format','1','select','','','formats','',''],
